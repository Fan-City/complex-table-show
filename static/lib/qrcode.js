...
<html lang="en">
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6Mjg5NTU0Nzk1OmRiMzc2Y2IzODA1NzFiNTA4NjE4ZWMzY2UwN2M5M2NlYWIwOTQ3NzM4MGQ2ZDMyNWY0NGEyYzBhNDVkNmNmMGY=--5023c3ac5d08cf340437726b6ee34e13d8458e87">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="3B03:3FBC:C6A0D0:12D7452:5B2F8CBC" data-pjax-transient>
...
<meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="3B03:3FBC:C6A0D0:12D7452:5B2F8CBC" /><meta name="octolytics-dimension-region_edge" content="ap-southeast-1" /><meta name="octolytics-dimension-region_render" content="iad" /><meta name="octolytics-actor-id" content="33258476" /><meta name="octolytics-actor-login" content="MichaelXu1983" /><meta name="octolytics-actor-hash" content="d19f5cc52b10f534621eaca3f414ef30928c14d90c4dbfce9afa9040d2a52e28" />
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="user-login" content="MichaelXu1983">

      <meta name="expected-hostname" content="github.com">
    <meta name="js-proxy-site-detection-payload" content="YTE2YjNkY2U5MTc2YzY4NTRmMzIxNGEwODRlYmQwZjdkYzA3MWI1ZWY1ZTJkMTYzZDRlMjQxN2YxZmY0MDc0Znx7InJlbW90ZV9hZGRyZXNzIjoiMjIzLjEwNC4zLjIzMSIsInJlcXVlc3RfaWQiOiIzQjAzOjNGQkM6QzZBMEQwOjEyRDc0NTI6NUIyRjhDQkMiLCJ0aW1lc3RhbXAiOjE1Mjk4NDI4ODQsImhvc3QiOiJnaXRodWIuY29tIn0=">

    <meta name="enabled-features" content="UNIVERSE_BANNER,FREE_TRIALS,MARKETPLACE_INSIGHTS,MARKETPLACE_INSIGHTS_CONVERSION_PERCENTAGES">

  <meta name="html-safe-nonce" content="69a7868ed62d7f871fa522625cd08ea31bca87c0">
...
>
  <div class="position-relative">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="7323572" data-scoped-search-url="/davidshimjs/qrcodejs/search" data-unscoped-search-url="/search" action="/davidshimjs/qrcodejs/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=G/Dx3nIDH4rtE+MHFr9j853YW9bDWl0jRgZggBk7d+CxBx5/C6pMyK+xBVKUitCqoLx6fuiW8thtvSXP42P+aQ=="
          spellcheck="false"
          autocomplete="off"
          >
...
<ul class="user-nav d-flex flex-items-center list-style-none" id="user-links">
  <li class="dropdown">
    ...
    <a aria-label="You have no unread notifications" class="notification-indicator tooltipped tooltipped-s  js-socket-channel js-notification-indicator" data-hotkey="g n" data-ga-click="Header, go to notifications, icon:read" data-channel="notification-changed:33258476" href="/notifications">
...
<a class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
  ...
  <li class="dropdown">
    ...
    <details class="details-overlay details-reset js-dropdown-details d-flex pl-2 flex-items-center">
      <summary class="HeaderNavlink name mt-1"
        ...
        <img alt="@MichaelXu1983" class="avatar float-left mr-1" src="https://avatars1.githubusercontent.com/u/33258476?s=40&amp;v=4" height="20" width="20">
        <span class="dropdown-caret"></span>
      </summary>

      <ul class="dropdown-menu dropdown-menu-sw">
        <li class="dropdown-header header-nav-current-user css-truncate">
          Signed in as <strong class="css-truncate-target">MichaelXu1983</strong>
        </li>

        <li class="dropdown-divider"></li>

        <li><a class="dropdown-item" href="/MichaelXu1983" data-ga-click="Header, go to profile, text:your profile">
          Your profile
        </a></li>
        <li><a class="dropdown-item" href="/MichaelXu1983?tab=stars" data-ga-click="Header, go to starred repos, text:your stars">
          Your stars
        </a></li>
        ...
        <li><!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="FXhVYUKRXGfPj0A1mWAI7ep+qYTCoicnGGaf9AM/LcNxMRPnqtjWel837vpig6sM+l+Pmbs2zE1+RMY4RxaMmQ==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="G8iaPdrZBbmspLmsYPbZ/DwbJNytRqDsjcqLcDA1Hh1/gdy7MpCPpDwcF2ObFXodLDoCwdTSS4br6NK8dBy/Rw==" />
          <button type="submit" class="dropdown-item dropdown-signout" data-ga-click="Header, sign out, icon:logout">
            Sign out
          </button>
</form>      </div>
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="8d0CR2HLdhxl5pzsH0DROT/8KuLEtr1u5SsPSXB4JyXFMSHnGiAcjCUM/8AuGRdD9wTHLe+q1t192teAbGwo3Q==" />      <input type="hidden" name="repository_id" id="repository_id" value="7323572" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/davidshimjs/qrcodejs/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="NanYbYRlsERRUYcWdre9oTJm1/NMopX5FBouXPhw+UXLr1aVKGkKr5CREzARZd43XbEXvzBXVqL7wT7sKKxAuA==" />
      ...
      <button
        ...
        <a class="social-count js-social-count" href="/davidshimjs/qrcodejs/stargazers"
           aria-label="5302 users starred this repository">
          5,302
        </a>
</form>
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/davidshimjs/qrcodejs/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="7VcQ3LVBB9Uy/uORMguL4i9Iz+JXTjDNHFXwbDBLcNSraAsAvogrFYPWkK1y2jgfka265COVS+/L6J6RfJUPJw==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/davidshimjs/qrcodejs/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="KbZU2o8tnvsLKzyUjSxMTVECRe4UpoGVP89b7A/Qfob9Az/RzGkhK05hDkJhdGWGHO6J3oYM4MqiBGcS1qcqVA==" />
            <button
                type="submit"
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="commit-tease">
      ...
      <div>
        <a rel="contributor" data-skip-pjax="true" data-hovercard-user-id="284023" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/ysangkok"><img class="avatar" src="https://avatars0.githubusercontent.com/u/284023?s=40&amp;v=4" width="20" height="20" alt="@ysangkok" /></a>
        <a class="user-mention" rel="contributor" data-hovercard-user-id="284023" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/ysangkok">ysangkok</a>
          <a data-pjax="true" title="Swap col and row in SVG output so that the display equals the PNG output" class="message" href="/davidshimjs/qrcodejs/commit/11d1bdbb8ae50ae6c5f23da47e6492e617427abd">Swap col and row in SVG output so that the display equals the PNG output</a>
      </div>
      ...
      <button type="button" class="btn-link muted-link contributors-toggle" data-facebox="#blob_contributors_box">
        <strong>6</strong>
         contributors
          ...
          <a class="avatar-link" data-hovercard-user-id="3103540" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=davidshimjs">
      <img class="avatar" src="https://avatars2.githubusercontent.com/u/3103540?s=40&amp;v=4" width="20" height="20" alt="@davidshimjs" /> 
</a>    <a class="avatar-link" data-hovercard-user-id="928988" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=davidcl64">
      <img class="avatar" src="https://avatars0.githubusercontent.com/u/928988?s=40&amp;v=4" width="20" height="20" alt="@davidcl64" /> 
</a>    <a class="avatar-link" data-hovercard-user-id="284023" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=ysangkok">
      <img class="avatar" src="https://avatars0.githubusercontent.com/u/284023?s=40&amp;v=4" width="20" height="20" alt="@ysangkok" /> 
</a>    <a class="avatar-link" data-hovercard-user-id="870673" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=taku0">
      <img class="avatar" src="https://avatars0.githubusercontent.com/u/870673?s=40&amp;v=4" width="20" height="20" alt="@taku0" /> 
</a>    <a class="avatar-link" data-hovercard-user-id="185571" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=ghigo">
      <img class="avatar" src="https://avatars3.githubusercontent.com/u/185571?s=40&amp;v=4" width="20" height="20" alt="@ghigo" /> 
</a>    <a class="avatar-link" data-hovercard-user-id="2834976" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidshimjs/qrcodejs/commits/master/qrcode.js?author=lukem512">
      <img class="avatar" src="https://avatars0.githubusercontent.com/u/2834976?s=40&amp;v=4" width="20" height="20" alt="@lukem512" /> 
</a>
    ...
    <div id="blob_contributors_box" style="display:none">
      ...
      <ul class="facebox-user-list" data-facebox-id="facebox-description">
          <li class="facebox-user-list-item">
            <a class="d-inline-block" data-hovercard-user-id="3103540" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidshimjs"><img src="https://avatars3.githubusercontent.com/u/3103540?s=48&amp;v=4" width="24" height="24" alt="@davidshimjs" /></a>
            <a data-hovercard-user-id="3103540" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidshimjs">davidshimjs</a>
          </li>
          <li class="facebox-user-list-item">
            <a class="d-inline-block" data-hovercard-user-id="928988" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidcl64"><img src="https://avatars1.githubusercontent.com/u/928988?s=48&amp;v=4" width="24" height="24" alt="@davidcl64" /></a>
            <a data-hovercard-user-id="928988" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/davidcl64">davidcl64</a>
          </li>
          <li class="facebox-user-list-item">
            <a class="d-inline-block" data-hovercard-user-id="284023" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/ysangkok"><img src="https://avatars1.githubusercontent.com/u/284023?s=48&amp;v=4" width="24" height="24" alt="@ysangkok" /></a>
            <a data-hovercard-user-id="284023" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/ysangkok">ysangkok</a>
          </li>
          <li class="facebox-user-list-item">
            <a class="d-inline-block" data-hovercard-user-id="870673" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/taku0"><img src="https://avatars1.githubusercontent.com/u/870673?s=48&amp;v=4" width="24" height="24" alt="@taku0" /></a>
            <a data-hovercard-user-id="870673" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/taku0">taku0</a>
          </li>
          <li class="facebox-user-list-item">
            <a class="d-inline-block" data-hovercard-user-id="185571" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/ghigo"><img src="https://avatars2.githubusercontent.com/u/185571?s=48&amp;v=4" width="24" height="24" alt="@ghigo" /></a>
            <a data-hovercard-user-id="185571" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/ghigo">ghigo</a>
          </li>
          <li class="facebox-user-list-item">
            <a class="d-inline-block" data-hovercard-user-id="2834976" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/lukem512"><img src="https://avatars1.githubusercontent.com/u/2834976?s=48&amp;v=4" width="24" height="24" alt="@lukem512" /></a>
            <a data-hovercard-user-id="2834976" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/lukem512">lukem512</a>
          </li>
      </ul>
    </div>
  </div>
    ...
    <div class="BtnGroup">
      ...
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/davidshimjs/qrcodejs/commits/master/qrcode.js">History</a>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
           href="x-github-client://openRepo/https://github.com/davidshimjs/qrcodejs?branch=master&amp;filepath=qrcode.js"
           aria-label="Open this file in GitHub Desktop"
           data-ga-click="Repository, open with desktop, type:mac">
            <svg class="octicon octicon-device-desktop" viewBox="0 0 16 16" version="1.1" width="16" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M15 2H1c-.55 0-1 .45-1 1v9c0 .55.45 1 1 1h5.34c-.25.61-.86 1.39-2.34 2h8c-1.48-.61-2.09-1.39-2.34-2H15c.55 0 1-.45 1-1V3c0-.55-.45-1-1-1zm0 9H1V3h14v8z"/></svg>
        </a>

          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/davidshimjs/qrcodejs/edit/master/qrcode.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="XOqi9vB435+BLY8G3mtmbczGBVkSvy5gE+R97zaud5iJkYl3IGNtgPCGg5mtGI558Ytjo6fphZymY06P2EL0AQ==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/davidshimjs/qrcodejs/delete/master/qrcode.js" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Qd4MRXka1JfB0sVrSM41jT/lXWL7RGGVC0GhBkjhWQWjaEhMP0LfoirPFQ1Kuj4+0WSBcBlGSL5iTsY6gC06Vg==" />
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.31391s from unicorn-7bbc797475-kks62">GitHub</span>, Inc.</li>
